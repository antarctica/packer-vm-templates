...
| `antarctica/centos7` | DigitalOcean Image   | New    | DigitalOcean   | [Atlas](https://atlas.hashicorp.com/antarctica/artifacts/centos7/types/digitalocean.droplet/6)                                                                                                     | Available only in the `lon1` region, includes private networking but not backups [1] [4] |
